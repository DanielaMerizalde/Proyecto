...
C     
C     Generated by MadGraph5_aMC@NLO v. 2.9.23, 2025-03-14
...
C     
C     Process: s s~ > phidm > u u~ WEIGHTED<=2 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
     ...
     $   *small_width_treatment)), ZERO)
        IF(ZERO.ne.0d0) fk_ZERO = SIGN(MAX(ABS(ZERO), ABS(mdl_msdm__2
     $   *small_width_treatment)), ZERO)
      endif
      AMP(:,:) = (0d0,0d0)
            CALL IXXXXX(P(0,1),MDL_MS,+1,+1*IC(1),W(1,1))  !  count 1
      CALL IXXXXX(P(0,1),MDL_MS,-1,+1*IC(1),W(1,2))  !  count 1
      CALL OXXXXX(P(0,2),MDL_MS,+1,-1*IC(2),W(1,3))  !  count 1
      CALL OXXXXX(P(0,2),MDL_MS,-1,-1*IC(2),W(1,4))  !  count 1
      CALL OXXXXX(P(0,3),MDL_MU,+1,+1*IC(3),W(1,5))  !  count 2
      CALL OXXXXX(P(0,3),MDL_MU,-1,+1*IC(3),W(1,6))  !  count 2
      CALL IXXXXX(P(0,4),MDL_MU,+1,-1*IC(4),W(1,7))  !  count 2
      CALL IXXXXX(P(0,4),MDL_MU,-1,-1*IC(4),W(1,8))  !  count 2
      CALL FFS1_3(W(1,1),W(1,3),GC_1,MDL_MSDM__2,FK_ZERO,W(1,9))  !  count 2
      CALL FFS1_3(W(1,2),W(1,4),GC_1,MDL_MSDM__2,FK_ZERO,W(1,10))  !  count 2
      CALL FFS1_0(W(1,7),W(1,5),W(1,9),GC_1,AMP(2,1))
      CALL FFS1_0(W(1,7),W(1,5),W(1,10),GC_1,AMP(4,1))
      CALL FFS1_0(W(1,8),W(1,6),W(1,9),GC_1,AMP(1,1))
      CALL FFS1_0(W(1,8),W(1,6),W(1,10),GC_1,AMP(3,1))  !  count 1
